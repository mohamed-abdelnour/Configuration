...
static const char *fonts[]          = { "Iosevka:style=Regular:size=11:antialias=true:hinting=true:hintstyle=1" };
// static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#282C34";
static const char col_gray2[]       = "#3B4048";
static const char col_gray3[]       = "#ABB2BF";
// static const char col_gray4[]       = "#3E4452";
...
static const char *atermcmd[]  = { "st", NULL };

static Key keys[] = {
	/* modifier                     key         function        argument */
	{ MODKEY,                       XK_p,       spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return,  spawn,          {.v = termcmd } },
	{ Mod1Mask,                     XK_Return,  spawn,          {.v = atermcmd } },
	...
	{ MODKEY,                       XK_m,       spawn,          SHCMD("pcmanfm") },
	{ MODKEY,                       XK_v,       spawn,          SHCMD("clipmenu -i") },
	{ MODKEY,                       XK_o,       spawn,          SHCMD("$HOME/.scripts/dmenu_open") },
	{ 0,                            XK_Print,   spawn,          SHCMD("$HOME/.scripts/screenshot") },
	...
	{ MODKEY|ShiftMask,             XK_q,       spawn,          SHCMD("$HOME/.scripts/logout_menu") },
    // patches
